...
class DDPGGridsearch():
    ...
    def __init__(self, lr_actor_params = [1.5e-4], lr_critic_params = [1.5e-4], 
                 gamma_params = [0.99], buffer_size_params = [int(1e5)], batch_size_params = [128], 
                 weight_decay_params = [1e-4], tau_params = [1e-3], random_seed_params = [4],
                 fc1_units_a_params = [600], fc2_units_a_params = [400], fc3_units_a_params = [200]):
    ...
    def create_gridsearch_params(self) -> List:
        ...
        param_list = [DDPGHyperparameters(lr_actor=p[0], lr_critic=p[1], gamma=p[2], 
                                          ...
                                          fc3_units_a=p[10],) for p in param_list]
